...
dataset_path = "/Users/mathieu/Desktop/Kartezio/Cells-task/Suspension-cells/"
...
def main():
    ...
    dataset = read_dataset(dataset_path, filename="dataset_cells-task.suspension.csv", meta_filename="../META_cells-task.JSON", preview=True)
    ...
    #p, _ = model.predict(dataset.test_x) # Prediction on test set
    for i, pi in enumerate(p):
        ...
        cv2.imwrite(f"{dataset_path}Instance_segmentation/Results_preview/train{i}final_Cells-task_suspension_IS.png", overlayed)
